class Scene3 extends Phaser.Scene {
	...
	preload() {
		...
		this.load.image('wave1', 'assets/wave1.png');
		this.load.image('wave2', 'assets/wave2.png');
		this.load.image('wave3', 'assets/wave3.png');
		...
		this.load.spritesheet('jump', 'assets/dude2.png', {
			frameWidth: 45,
			frameHeight: 110
		});
		...
		this.load.spritesheet('bird_explosion', 'assets/bird_explosion3.png', {
			frameWidth: 90,
			frameHeight: 100
		});
	}
	...
	create() {
		...
		this.wave1 = this.add.tileSprite(500, 715, config.width, config.height, 'wave1');
		this.wave2 = this.add.tileSprite(500, 745, config.width, config.height, 'wave2');
		this.wave3 = this.add.tileSprite(500, 775, config.width, config.height, 'wave3');
		this.clouds = this.add.tileSprite(400, -100, config.width, config.height, 'clouds');
